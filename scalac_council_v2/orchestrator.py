...
1. Upewnij się że workspace istnieje:
   ls /root/.openclaw/workspace/scalac-council-v2/
...
3. Spawn agentów równolegle (w Kimi Code):
   ...
   sessions_spawn(
       runtime="subagent",
       task="Jesteś Marcus, Offer Architect w Scalac. Przeczytaj /root/.openclaw/workspace/scalac-council-v2/shared/brief.md. Napisz Round 1 do /root/.openclaw/workspace/scalac-council-v2/shared/discussion/round_1_marcus.md. Poczekaj na innych agentów. Czytaj ich outputy i odpowiadaj w kolejnych rundach. Cel: 3 rundy lub konsensus. Final: /root/.openclaw/workspace/scalac-council-v2/output/marcus_offer.md",
       label="marcus"
   )
   ...
   sessions_spawn(
       runtime="subagent",
       task="Jesteś Elena, Funnel Architect w Scalac. Przeczytaj brief i /root/.openclaw/workspace/scalac-council-v2/shared/discussion/round_1_marcus.md (jak gotowe). Napisz Round 1 do /root/.openclaw/workspace/scalac-council-v2/shared/discussion/round_1_elena.md. Debata z Marcusem o pricing vs conversion. Final: /root/.openclaw/workspace/scalac-council-v2/output/elena_funnel.md",
       label="elena"
   )
...
5. Sprawdź dyskusję:
   read("/root/.openclaw/workspace/scalac-council-v2/shared/discussion/round_1_marcus.md")

6. Finalne outputy:
   read("/root/.openclaw/workspace/scalac-council-v2/output/FINAL_PROPOSAL.md")
